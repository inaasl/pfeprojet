 ...
 <br><br><br><br><br><br><br>
        ...
        <%
    			...
    			ServicepfeprojetRemote service = (ServicepfeprojetRemote) obj;
        			...
        			out.print(" <tr><td align=\"center\"> "+service.rechercheEntreprise(nomEntreprise).get(i).getNom().toString() +"</td><td <td align=\"center\">"+service.rechercheEntreprise(nomEntreprise).get(i).getAdresse().toString()+"</td><td align=\"center\">"+service.rechercheEntreprise(nomEntreprise).get(i).getTel().toString()+"</td><td align=\"center\"> <form action=\"ficheentreprise\" method=\"GET\" ><input type=\"hidden\" id=\"thisField\" name=\"numEntreprise\" value="+service.rechercheEntreprise(nomEntreprise).get(i).getNumero()+"> <input type=\"submit\" name=\" Consulter la fiche \" value=\" Consulter la fiche \" /></form></td></tr>");
        			}
    				out.print("</table>");
        %>
