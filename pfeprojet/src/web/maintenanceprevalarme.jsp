...
<body>
	...
	<%
		...
		out.println("<br><center><h3>Maintenance Préventive des Alarmes Incendie</h3></center><br>");
		out.println("<center><input type=\"button\" name=\"AjoutAlarme\" value=\"Ajouter une Alarme incendie\"  onclick=\"self.location.href='installationalarme.jsp?ajout=23'\"></button></center>");
		...
		for(i=0;i<A.size();i++){
					out.println(" <tr><td > " + A.get(i).getNumero()+
						...
						"</td><td> <form action=\"maintenanceprevalarmevalidee.jsp\" method=\"GET\" ><input type=\"hidden\" id=\"idalarme\" name=\"numalarme\" value="
						+ A.get(i).getNumero()
