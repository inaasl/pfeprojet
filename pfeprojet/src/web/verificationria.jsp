...
<body>
	...
	<%
		...
		out.println("<br><center><h3>Vérification des RIA</h3></center><br>");
		out.println("<center><input type=\"button\" name=\"AjoutRIA\" value=\"Ajouter RIA \"  onclick=\"self.location.href='installationria.jsp?ajout=13'\"></button></center>");
		...
		out.print("<thead><tr><th> N° Ria </th><th> Emplacement </th><th>Pression Statique</th><th>Pression Dynamique</th><th>Portee</th><th> Type </th><th>Observation</th><th>Etat défecteux</th></tr>");
		out.print("</thead><tbody>");
	      
		for(i=0;i<R.size();i++){
					observation=service.rechercheObservationVerification(R.get(i).getNumero());
		...
		conclusion=service.rechercheConclusionVerificationRia(num);
		...
		session.setAttribute("organes",R);
	%>
	</div>
	<%
	 }
