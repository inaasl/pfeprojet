...
<%
	...
	out.println("<br><center> Verification effectuée avec succès </center>");

	out.println("<center><a href=\"verificationdesenfumagenaturel.jsp\">Effectuer une nouvelle vérification </a></center>");
	out.println(
