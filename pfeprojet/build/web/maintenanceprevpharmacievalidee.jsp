...
<body>
	...
	<%
		...
		P=(List<Pharmacie>)session.getAttribute("Pharmacies");
		...
		for (i=0;i <P.size(); i++) {
				...
				MP=service.MaintenancePreventiveOrgane(P.get(i), observation, conclusion, numT, Date.valueOf(formater.format(date)),Etat);
