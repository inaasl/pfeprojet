...
<body>
	...
	%>
<form action="ajoutouvrantvalidee.jsp" method="post">
		 <fieldset>
		 <legend><b>Ajout d'ouvrants - Désenfumage Naturel</b></legend>
		<br>
		<table>
     <tr></tr>
	 </table>
    ...
    new Vue({
        ...
        methods: {
          ...
          ajouter: function() {
            this.ouvrants.push({commande: this.inputCommande, nom: this.inputNom});
            $.ajax({
                url: "ajoutouvrant.jsp",
                data: {
