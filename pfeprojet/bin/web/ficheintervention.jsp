...
<body>
	...
	<%
		...
		if(pdf.getInterventions().get(0).getOrgane() instanceof Extincteur){
			...
			for(i=0;i<pdf.getInterventions().size();i++){
			out.println("<tr><td>"+pdf.getInterventions().get(i).getNumero()
						+"</td><td>"+pdf.getInterventions().get(i).getOrgane().getNumero()
						+"</td><td>"+((Extincteur)pdf.getInterventions().get(i).getOrgane()).getAnnee()
						+"</td><td>"+pdf.getInterventions().get(i).getOrgane().getEmplacement()
						+"</td><td>"+((Extincteur)pdf.getInterventions().get(i).getOrgane()).getType().getNom()
						+"</td><td>"+((Extincteur)pdf.getInterventions().get(i).getOrgane()).getMarque().getNom()
						+"</td><td>"+pdf.getInterventions().get(i).getOrgane().getObservation()
					+"</td></tr>");
			}
		}
